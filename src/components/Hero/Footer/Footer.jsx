    ...
    <footer className="bg-[#252A25]  py-12">
      <div className="container mx-auto justify-center items-center  flex flex-wrap">
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 mb-8 md:mb-0">
          ...
          <h2 className="text-md  mb-4 text-white">Website is operated by EU International Gaming Ltd.</h2>
        </div>

        {/* Second Column */}
        <div className="w-full md:w-1/2 lg:w-1/4 mb-8 md:mb-0">
          <h2 className="text-2xl font-bold mb-4 text-[#F5D148]">Information</h2>
        ...
        <div className="w-full md:w-1/2 lg:w-1/3 flex flex-col ">
          ...
          <div className="flex flex-col flex-wrap items-center mb-4">
            <h2 className="text-2xl  text-[#F5D148]  font-bold mr-4">Security & Game Integrity</h2>
            {/* Add 4 images here */}
            <div className="flex gap-3 flex-wrap flex-row">
            <img src={plus} alt="18plus" className="w-[130px]  " />
            <img src={responsibly} alt="responsibly" className="w-[130px]  " />
            <img src={satisfaction} alt="satisfaction" className="w-[130px]  " />
          ...
          <div className="flex  flex-col items-center">
            <h2 className="text-2xl text-[#F5D148] font-bold mr-4">Payment Partner</h2>
            {/* Add 3 images here */}
